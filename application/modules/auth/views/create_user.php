...
<!--<div class="container-fluid">-->
      ...
      <div class="well">
            ...
            <fieldset>
                  ...
                  <div class="form-group"><label for="input" class="col-lg-2 col-lg-offset-2 control-label"><?php echo form_submit('submit', lang('create_user_submit_btn'), 'class="btn btn-lg btn-primary"');?></label></div>

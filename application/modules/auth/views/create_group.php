...
<fieldset>
	<legend><?php echo lang('create_group_subheading');?></legend>
      ...
      <div class="form-group">
      	...
      	<?php echo form_submit('submit', lang('create_group_submit_btn'), 'class="btn-primary btn-lg"');?>
      	</label>
          <a href="<?php echo site_url('admin/users');?>"><button type="button" class="btn-primary btn-lg btn-link">Home</button></a>
      </div>

...
*/
$config['tables']['users']           = 'boda_users';
$config['tables']['groups']          = 'boda_groups';
$config['tables']['users_groups']    = 'boda_users_groups';
$config['tables']['login_attempts']  = 'boda_login_attempts';
